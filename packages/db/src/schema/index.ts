...
export const checklists = pgTable(
  ...
  (table) => [index("idx_checklists_user").on(table.userId)],
);
...
export const checklistItems = pgTable(
  ...
  (table) => [index("idx_checklist_items_checklist").on(table.checklistId)],
);
...
export const checklistRunItems = pgTable(
  ...
  (table) => ({
    uniqueRunItem: uniqueIndex("uq_run_items_run_item").on(
      table.runId,
      table.itemId,
    ),
