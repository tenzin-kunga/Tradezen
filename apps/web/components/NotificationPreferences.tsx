...
const notificationTypes = [
  {
    ...
    description: "Get notified when your drawdown exceeds thresholds",
  },
  {
    type: "fomo_warning",
    label: "FOMO Warnings",
    description: "Alerts when emotional trading indicators are high",
  },
  {
    type: "coaching",
    label: "Coaching Alerts",
    description: "Losing streak and performance pattern alerts",
  },
  {
  ...
  },
  {
    ...
    description: "Alerts to stay disciplined with your trading plan",
  },
  {
    type: "weekly_summary",
