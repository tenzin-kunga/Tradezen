        ...
        <div className="flex-[3] min-w-0">
          <TooltipProvider>
            <div
              ...
              style={{ gridTemplateColumns: `40px repeat(${weekCount}, 1fr)` }}
            >
              {/* Week labels header row */}
              <div />
...
function Row({
  ...
  return (
    <>
      ...
      {Array.from({ length: weekCount }, (_, colIdx) => {
        const day = weeks[colIdx]?.[rowIdx] ?? null;
          ...
          <Tooltip key={colIdx}>
            ...
            {day && !isEmpty && (
              <TooltipContent side="bottom" sideOffset={6}>
                ...
                >
                  {day.pnl >= 0 ? "+" : ""}${day.pnl.toFixed(0)} · {day.trades}{" "}
