...
export default function SettingsPage() {
  ...
  const inputCls =
    "w-full border rounded px-3 py-2.5 text-sm outline-none box-border focus:border-[#22d3ee]";
  ...
  return (
    <div
      className="min-h-screen p-4 md:p-6 lg:p-10"
      ...
      >
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
            {(["dark", "light", "midnight", "tradingview"] as const).map(
              (t) => (
                <button
                  key={t}
                  type="button"
                  ...
                  style={{
                    borderColor:
                      theme === t ? "var(--accent-cyan)" : "var(--border)",
                    backgroundColor:
                      theme === t
                        ? "var(--bg-surface-hover)"
                        : "var(--bg-primary)",
                    color:
                      theme === t ? "var(--text-primary)" : "var(--text-muted)",
