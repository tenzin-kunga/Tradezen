      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-xs tracking-widest" style={{ color: "var(--text-dim)" }}>OR REGISTER WITH EMAIL</span>
            <div className="flex-1 h-px" style={{ background: "var(--border)" }} />
          </div>

          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              <label className="block text-xs tracking-widest mb-1.5" style={{ color: "var(--text-muted)" }}>EMAIL</label>
              <input
            ...
            <div>
              <label className="block text-xs tracking-widest mb-1.5" style={{ color: "var(--text-muted)" }}>USERNAME</label>
              <input
                className="w-full rounded px-3.5 py-3 text-sm outline-none box-border"
                style={{
                  background: "var(--bg-primary)",
            ...
            <div>
              <label className="block text-xs tracking-widest mb-1.5" style={{ color: "var(--text-muted)" }}>CONFIRM PASSWORD</label>
              <input
                className="w-full rounded px-3.5 py-3 text-sm outline-none box-border"
                type="password"
                style={{
