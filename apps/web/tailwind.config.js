  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'metric-hero': ['var(--metric-hero)', { lineHeight: 'var(--metric-hero--line-height)', letterSpacing: 'var(--metric-hero--letter-spacing)', fontWeight: 'var(--metric-hero--font-weight)' }],
        'metric-primary': ['var(--metric-primary)', { lineHeight: 'var(--metric-primary--line-height)', letterSpacing: 'var(--metric-primary--letter-spacing)', fontWeight: 'var(--metric-primary--font-weight)' }],
        'metric-secondary': ['var(--metric-secondary)', { lineHeight: 'var(--metric-secondary--line-height)', letterSpacing: 'var(--metric-secondary--letter-spacing)', fontWeight: 'var(--metric-secondary--font-weight)' }],
        'section-title': ['var(--section-title)', { lineHeight: 'var(--section-title--line-height)', letterSpacing: 'var(--section-title--letter-spacing)', fontWeight: 'var(--section-title--font-weight)' }],
        body: ['var(--body)', { lineHeight: 'var(--body--line-height)', letterSpacing: 'var(--body--letter-spacing)', fontWeight: 'var(--body--font-weight)' }],
        label: ['var(--label)', { lineHeight: 'var(--label--line-height)', letterSpacing: 'var(--label--letter-spacing)', fontWeight: 'var(--label--font-weight)' }],
        meta: ['var(--meta)', { lineHeight: 'var(--meta--line-height)', letterSpacing: 'var(--meta--letter-spacing)', fontWeight: 'var(--meta--font-weight)' }],
      },
      spacing: {
        0: 'var(--space-0)',
        '0.5': 'var(--space-0\\.5)',
